...
namespace PostAgent.databases
{
    public static class DbExtensions
    {
        ...
        public static int NextValueFor(this DbContecxtAbstract dbContext, string genName)
        {
        ...
        public static void DetachAll<T>(this DbContecxtAbstract dbContext, DbSet<T> dbSet) where T : class
        {
        ...
        public static void Refresh(this DbContecxtAbstract dbContext, RefreshMode mode, IEnumerable collection)
        {
        ...
        public static void Refresh(this DbContecxtAbstract dbContext, RefreshMode mode, object entity)
        {
            var objectContext = ((IObjectContextAdapter)dbContext).ObjectContext;
